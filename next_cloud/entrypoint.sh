...
su -s /bin/bash www-data -c "php /var/www/html/occ config:system:set trusted_domains 3 --value=98.84.32.245"
su -s /bin/bash www-data -c "php /var/www/html/occ config:system:set trusted_domains 4 --value=98.98.186.148"
su -s /bin/bash www-data -c "php /var/www/html/occ config:system:set trusted_domains 5 --value=190.145.240.152"
su -s /bin/bash www-data -c "php /var/www/html/occ config:system:set trusted_domains 6 --value=api"
su -s /bin/bash www-data -c "php /var/www/html/occ config:system:set trusted_domains 7 --value=worker"
